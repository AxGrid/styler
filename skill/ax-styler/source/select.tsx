...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'border border-border bg-bg-elevated px-3 py-2 text-sm shadow-xs',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-[var(--radius-md)] border border-border bg-bg-elevated text-fg shadow-lg',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center gap-2 rounded-[var(--radius-sm)]',
